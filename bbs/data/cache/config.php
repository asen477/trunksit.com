...
原创内容',
			...
			'avatarUrl' => 'http://www.trunksit.com/bbs/windid/attachment',
			'hash' => 'OeYucP03',
			'cookie.pre' => '9ac',
			'info.mail' => 'asen477@gmail.com',
			'info.url' => 'http://www.trunksit.com/bbs',
			...
			'info.icp' => '辽ICP备15017150号-1',
			'info.logo' => '',
			'statisticscode' => '<script>
var _hmt = _hmt || [];
(function() {
  var hm = document.createElement("script");
  hm.src = "https://hm.baidu.com/hm.js?34553b75b47b28338904f949c399a662";
  ...
  s.parentNode.insertBefore(hm, s);
		...
		'bbs' => array(
			'content.length.max' => '9223372036854775807',
...
3:地板',
		...
		'seo' => array(
			'seo_bbs_forumlist_0' => array(
				...
				'param' => '0',
				'title' => '蓝黑色 - 特蓝克斯',
				'keywords' => '特蓝克斯、蓝黑色、时代、全站工程师、沈阳IT、truinksit、trunks,产品设计,运营',
				'description' => '特蓝克斯、蓝黑色、时代、全站工程师、沈阳IT、truinksit、trunks,产品设计,运营',
			),
			'seo_bbs_new_0' => array(
				'mod' => 'bbs',
				'page' => 'new',
		...
		'windid' => array(
			'windid' => 'local',
			'serverUrl' => 'http://www.trunksit.com/bbs/windid',
			'clientId' => '1',
			'clientKey' => 'e18999893420454d461836feb57123da',
			'connect' => 'db',
		),
	),
	'expires' => '0',
