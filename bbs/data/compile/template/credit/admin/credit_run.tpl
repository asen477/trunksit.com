...
<div class="wrap">
	<div class="nav">
	<ul class="cc">
		<li class="<?php echo htmlspecialchars($currentTabs['run'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit'; ?>">积分设置</a></li>
		<li class="<?php echo htmlspecialchars($currentTabs['strategy'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=strategy'; ?>">积分策略</a></li>
		<li class="<?php echo htmlspecialchars($currentTabs['recharge'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=recharge'; ?>">积分充值</a></li>
		<li class="<?php echo htmlspecialchars($currentTabs['exchange'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=exchange'; ?>">积分转换</a></li>
		<li class="<?php echo htmlspecialchars($currentTabs['transfer'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=transfer'; ?>">积分转账</a></li>
		<li class="<?php echo htmlspecialchars($currentTabs['log'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=log'; ?>">积分日志</a></li>
	</ul>
</div>
	<form class="J_ajaxForm" method="post" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=doSetting'; ?>" data-role="list">
	<div class="table_list">
		<table id="J_table_list" width="100%">
			...
			<tr data-key="<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>">
				...
				<?php  if($key > 4) {?>
				<td><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=credit&c=credit&a=doDelete'; ?>" class="mr10 J_ajax_del" data-pdata="{'creditId': '<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>'}">[删除]</a></td>
				<?php } else {?>
				<td>-- --</td>
				<?php }?>
			</tr>
