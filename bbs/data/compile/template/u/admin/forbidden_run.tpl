...
<div class="nav">
	...
	<ul class="cc">
		<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=forbidden'; ?>">手动禁止</a></li>
		<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=forbidden&a=auto'; ?>">自动禁止</a></li>
		<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=forbidden&a=list'; ?>">解除禁止</a></li>
	</ul>
</div>
<form class="J_ajaxForm" data-role="list" method="post" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=forbidden&a=dorun'; ?>">
...
<?php foreach ($types as $key => $value) {?>
					<li><label><input type="checkbox" name="type[]" value="<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>"><span><?php echo htmlspecialchars($value['title'], ENT_QUOTES, 'UTF-8');?></span></label></li>
<?php }?>
				</ul>
			</td>
