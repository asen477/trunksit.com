...
<div class="wrap jj">
	<div class="nav">
		...
		<ul class="cc">
			<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?uid=', rawurlencode($uid),'&m=u&c=manage&a=edit'; ?>">用户信息</a></li>
...
<!--====================用户编辑开始====================-->
<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=manage&a=doEdit'; ?>" method="post">
