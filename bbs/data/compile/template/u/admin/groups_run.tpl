...
<div class="nav">
	<ul class="cc">
		<li<?php echo $typeClasses['member'];?>><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=member&m=u&c=groups'; ?>">会员组</a></li>
		<li<?php echo $typeClasses['special'];?>><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=special&m=u&c=groups'; ?>">特殊组</a></li>
		<li<?php echo $typeClasses['system'];?>><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=system&m=u&c=groups'; ?>">管理组</a></li>
		<li<?php echo $typeClasses['default'];?>><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=default&m=u&c=groups'; ?>">默认组</a></li>
	</ul>
</div>

<form class="J_ajaxForm" data-role="list" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=groups&a=dosave'; ?>" method="post">
	...
	<table width="100%" id="J_group_table">
		...
		<tr>
			...
			<td>
				...
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?gid=', rawurlencode($group['gid']),'&m=u&c=groups&a=edit'; ?>" class="mr10">[基本权限]</a>
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?manage=1&gid=', rawurlencode($group['gid']),'&m=u&c=groups&a=edit'; ?>" class="mr10">[管理权限]</a>
				<?php  } else { ?>
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?gid=', rawurlencode($group['gid']),'&m=u&c=groups&a=edit'; ?>" class="mr10">[编辑]</a>
				<?php  } 
  if ($group['gid'] > 7) { ?>
				<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=u&c=groups&a=delete'; ?>" class="mr10 J_ajax_del" data-pdata="{'gid': '<?php echo htmlspecialchars($group['gid'], ENT_QUOTES, 'UTF-8');?>'}">[删除]</a>
				<?php  } ?>
			</td>
		</tr>
		<?php  } ?>
