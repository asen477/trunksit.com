...
<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?c=founder&a=doAdd'; ?>" method="post">
<div class="pop_cont pop_table" style="height:auto;">
	<table width="100%">
			...
			<tr>
				<th width="60">用户名</th>
				<?php  if($uid) { ?>
				<td><input type="text" class="input length_4" name="username" value="<?php echo htmlspecialchars($username, ENT_QUOTES, 'UTF-8');?>" readonly="readonly"></td>
				<?php  }else{ ?>
				<td><input type="text" class="input length_4" name="username" value="<?php echo htmlspecialchars($username, ENT_QUOTES, 'UTF-8');?>"></td>
				<?php  } ?>
			</tr>
			<tr>
				<th>密码</th>
