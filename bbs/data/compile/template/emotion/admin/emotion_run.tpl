...
<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=emotion&c=emotion&a=dorun'; ?>" method="post">
	<div class="table_list">
		...
		<?php  foreach ($catList as $cat){?>
			<tr>
				...
				<td>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?catid=', rawurlencode($cat['category_id']),'&m=emotion&c=emotion&a=emotion'; ?>" class="mr5">[管理]</a>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=emotion&c=emotion&a=deletecate'; ?>" class="mr5 J_ajax_del" data-pdata="{'cateid': '<?php echo htmlspecialchars($cat['category_id'], ENT_QUOTES, 'UTF-8');?>'}">[删除]</a>
				</td>
			</tr>
		<?php  } ?>
		</table>
	...
	<div class="table_list mb10">
		...
		<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=emotion&c=emotion&a=doadd'; ?>" method="post">
		<table width="100%">
			<tr>
				<td width="80">顺序</td>
