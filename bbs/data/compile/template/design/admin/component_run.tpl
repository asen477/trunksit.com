...
<div class="wrap">	
	<div class="nav">
		<ul class="cc">
			<li  class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=component'; ?>">模块模板</a></li>
			
		</ul>
	</div>
	<div class="h_a">搜索</div>
	<form method="post"  action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=component'; ?>" >
	...
	<div class="mb10">
			<a  class="btn" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=component&a=add1'; ?>"><span class="add"></span>添加模板</a>
	</div>
			<?php  if ($list) { ?>
	<div class="table_list">
		<table width="100%">
			...
			<tr>
				...
				<td><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?id=', rawurlencode($v['comp_id']),'&page=', rawurlencode($page),'&m=design&c=component&a=edit'; ?>" class="mr10">[编辑]</a><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=component&a=del'; ?>" class="J_ajax_del" data-pdata="{'id': '<?php echo htmlspecialchars($v['comp_id'], ENT_QUOTES, 'UTF-8');?>'}">[删除]</a></td>
			</tr>
			<?php  } ?>
		</table>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?page=', rawurlencode($_page_i),'&m=design&c=component'; 
