...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li class="<?php echo htmlspecialchars($run, ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=module'; ?>">模块管理</a></li>
			<li class="<?php echo htmlspecialchars($api, ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?type=api&m=design&c=module'; ?>">调用管理</a></li>
		</ul>
	</div>
	<div class="h_a">搜索</div>
	<form method="post" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=module'; ?>">
	...
	<div class="table_list">
		...
		<?php  foreach ($list as $v){ ?>
			<tr>
				...
				<td>
				<?php  if ($v['isdata']){ ?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=data'; ?>" class="mr10">[管理]</a>
				<?php  }else{ ?>
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=property&a=edit'; ?>" class="mr10">[管理]</a>
				<?php  } ?>
					<!--a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=data'; ?>" class="mr10">[数据]</a-->
					<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=permissions&a=module'; ?>" class="mr10">[权限管理]</a>
					<!-- <a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=module&a=script'; ?>"  class="mr10">[调用代码]</a> -->
					<!--a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?moduleid=', rawurlencode($v['module_id']),'&m=design&c=module&a=delete'; ?>" class="mr10">[删除]</a-->
				</td>
			</tr>
		<?php  } ?>
		</table>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?page=', rawurlencode($_page_i),'&m=design&c=module'; 
...
<?php } ?></div>
	...
	<form class="J_ajaxForm"  action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=design&c=module&a=clear'; ?>" method="post">
	<div class="btn_wrap">
