...
<!--==============================添加链接================================-->
	<form id="J_link_add_form" class="J_ajaxForm" data-role="list" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?m=link&c=link&a=doadd'; ?>" method="post">
